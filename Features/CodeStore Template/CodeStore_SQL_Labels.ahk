#Include *i %A_ScriptDir%\User\CodeStore\CodeStore_Shortkeys_SQL.ahk ; Our automatically created shortkeys.
...
ConfirmCheck := SEH_GuiConfirm("***DELETE***`r`rYou have chosen to delete ALL of the selected code. Are you sure you want to do this? This can not be undone.")
IfEqual ConfirmCheck, 1
	Return
SEH_GuiSubmit()
