...
{
Gui, Tab, SR Manager
	Gui, Add, Button, x692 y29 w100 h20 , Save Entry
	Gui, Add, Button, x692 y59 w100 h20 , Commit Entry
	Gui, Add, Button, x692 y89 w100 h20 , View RCA
	Gui, Add, ComboBox, x12 y9 w300 h20 , ComboBox
	Gui, Add, Text, x12 y29 w240 h20 , Analysis Log Name
	Gui, Add, Text, x595 y6 w200 h20 +Center, Active SR: 11610101477838101230123
	Gui, Add, ComboBox, x322 y9 w250 h20 , Networking Error|Permissions Error|Performance Issue|FYI
	Gui, Add, Text, x322 y29 w240 h20 , Entry Type
	Gui, Add, GroupBox, x12 y69 w670 h290 , Root Cause Analysis Active Entry
Gui, Tab
}
Return
