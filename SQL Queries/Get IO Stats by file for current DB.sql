-- I/O Statistics by file for the current database. This helps you characterize your workload better from an I/O perspective
-- Get VLF count for transaction log for the current database, number of rows equals VLF count. Lower is better!
